...
def get_missions():
    ...
    missions = {}
    missions['Asteroid Mining'] = [mission for mission in fleet_movement if mission.type in ['Asteroid Mining', 'Asteroid Mining (R)']]
    missions['Expedition'] = [mission for mission in fleet_movement if mission.type in ['Expedition', 'Expedition (R)']]

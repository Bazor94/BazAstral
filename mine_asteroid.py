    ...
    while not stop_threads.is_set(): 
        ...
        if asteroid_y != None:
            ...
            try:
                ...
                logging.warning(f'{x}:{y}:{z} | Mining Exception: {e}. Continue')
                continue
            ...
            try:
                ...
                logging.warning(f'{x}:{y}:{z} | FS Exception: {e}. Continue')
                continue
...
def mine_asteroids_cron(planets, fses, stop_threads, is_idle):
    is_asteroid_taken = {}
